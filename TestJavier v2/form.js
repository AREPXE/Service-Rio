document.addEventListener('DOMContentLoaded', async () => {
    ...
    const subTypes = {
        'Électronique': ['Téléphones', 'Ordinateurs', 'Accessoires', 'Appareils ménagers'],
        'Mode': ['Vêtements', 'Chaussures', 'Accessoires', 'Bijoux'],
        'Maison': ['Meubles', 'Décoration', 'Électroménagers', 'Ustensiles'],
        'Sport': ['Équipements', 'Vêtements de sport', 'Accessoires'],
        'Autres': ['Divers']
    };
